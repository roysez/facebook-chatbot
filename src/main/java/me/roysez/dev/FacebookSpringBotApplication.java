...
public class FacebookSpringBotApplication {

	private static final Logger logger = LoggerFactory.getLogger(FacebookSpringBotApplication.class);
	...
	public static void main(String[] args) {
		SpringApplication.run(FacebookSpringBotApplication.class, args);
	}
}
